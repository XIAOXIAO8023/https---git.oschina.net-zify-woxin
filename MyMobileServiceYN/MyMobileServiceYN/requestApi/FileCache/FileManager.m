...
+ (NSString*) cacheRootDirectory {
    ...
    cacheDirectory = [cacheDirectory stringByAppendingPathComponent:@"JFMallCaches"];
    return cacheDirectory;
}

//积分项目，根据用户id作为缓存目录，未登录时文件夹名称为0
+ (NSString*) cacheCommonDirectory:(NSString *)jfmallUserID {
    NSString *cacheDirectory = FileManager.cacheRootDirectory;
...
+(void)setObject:(NSData *)data forKey:(NSString *)key{
    ...
    NSString *path = FileManager.cacheRootDirectory;
