...
-(void)setHorizontalGrade:(float)horizontalGrade
{
	_horizontalGrade = horizontalGrade;
	UIBezierPath *progressline = [UIBezierPath bezierPath];
    
    [progressline moveToPoint:CGPointMake(0, self.frame.size.height/2.0)];
	[progressline addLineToPoint:CGPointMake((self.frame.size.width)*_horizontalGrade, self.frame.size.height/2.0)];
...
-(void)setPercentageGrade:(float)percentageGrade
{
    _percentageGrade = percentageGrade;
	UIBezierPath *progressline = [UIBezierPath bezierPath];
    
    [progressline moveToPoint:CGPointMake(0, self.frame.size.height)];
	[progressline addLineToPoint:CGPointMake(self.frame.size.width*_percentageGrade, self.frame.size.height)];
